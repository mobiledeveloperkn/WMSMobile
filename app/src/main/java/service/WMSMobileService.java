...
//        startSignalR();
    ...
    public boolean confirmSPMHeader(String intSPMHeaderId, String versionName, String intUserId) {
        boolean status = false;
    ...
    public boolean refreshSPMHeader(String intSPMHeaderId, String versionName) {
        boolean status = false;
        String METHOD_SERVER = new clsHardCode().txtMethodServerCancelSPMHeader;
        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put("intSPMHeaderId", intSPMHeaderId);
            jsonObject.put("pInfo", versionName);
        ...
        mHubConnection.received(new MessageReceivedHandler() {
            ...
            public void onMessageReceived(JsonElement jsonElement) {
                ...
                try {
                    ...
                    if(strMethodName.equalsIgnoreCase("pushDataOffline")){
