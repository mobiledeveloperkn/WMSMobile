...
//                + "select 2,'API','http://wms.kalbenutritionals.com/mobileapi','http://10.171.10.13/wmsonline',1;";

        txtQuery = "insert or replace into mconfig(intId,txtName,txtValue,txtDefaultValue,intEditAdmin )"
                + "select 2,'API','http://10.171.11.120/wmswebapi','http://10.171.10.13/wmsonline',1;";
        db.execSQL(txtQuery);
    }
