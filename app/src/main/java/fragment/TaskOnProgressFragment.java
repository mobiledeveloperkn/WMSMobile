...
public class TaskOnProgressFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_task_on_progress, container, false);
        mSwipeRefreshLayout = v.findViewById(R.id.onprogress_swipe_refresh_layout);
        mListView = v.findViewById(R.id.lv_onprogres);
...
//        adapter.notifyDataSetChanged();
        adapterProgress = new SwipeListAdapter(activity, mSPMDetailDataList);
